...
@NgModule({
  declarations: [HomeComponent,DataCMRComponent, DataNotCMRComponent, RequestComponent, ModalRulesComponent, StudyAreaListComponent, StudyAreaFormComponent, StudyAreaDetailsComponent, CampaignFormComponent,CampaignListComponent],
